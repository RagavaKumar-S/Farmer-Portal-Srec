    ...
    <form name="my-form" action="editprofile.php" method="post">
        <div class="form">
            <div class="input-group mt-4 s">
                ...
                <input type="text"  class="form-control border border-dark" id="staticEmail" name="name" value="<?php echo $name ?>">
            </div>
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-phone-alt mr-2"></i>Phone No.</span>
                </div>
                <input type="phonenumber"  class="form-control border border-dark" id="staticEmail" name="phonenumber" value="<?php echo $phone ?>">
            </div>
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
            ...
            <div class="input-group mt-4 s">
                ...
                <input type="text" class="form-control-plaintext border border-dark" id="staticEmail" name="pan" value=" <?php echo $pan ?> ">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-university mr-2"></i>Account No.</span>
                </div>
                <input type="text"  class="form-control border border-dark" id="staticEmail" name="account" value=" <?php echo $bank ?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-building mr-2"></i>Company</span>
                </div>
                <input type="text"  class="form-control border border-dark" id="staticEmail" name="comp" value="<?php echo $comp ?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-id-badge mr-2"></i>License</span>
                </div>
                <input type="text" class="form-control-plaintext border border-dark" id="staticEmail" name="license" value=" <?php echo $license ?>">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="far fa-envelope mr-2"></i>Email id </span>
                </div>
                <input type="email"  class="form-control border border-dark" id="staticEmail" name="mail" value="<?php echo $mail ?> ">
            </div> 
        </div>
        <button type="submit" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:goldenrod" name="confirm">Confirm</button>
        <br>
        <a href="BuyerChangePassword.php"><button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:goldenrod">Change Password</button></a>
        </form>
    ...
    <section id="footer" class="myfooter">
        <div class="container">
            ...
            <div class="row">
                ...
                <p><u><a href="#">Farmer Market portal</a></u></p>
                </div>
                </hr>
            </div>
        </div>
