      ...
      <style>
           * {
           ...
           .select_element {
                ...
                border: none;
                /* change property tex to text-decoration: ; */
 ...
 <body>
      ...
      <body>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Website/7.jpg" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/6.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/5.jpg" alt="Second slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Website/1.jpg" alt="Second slide">
                          </div>
           ...
           <h1 style="font-weight: bold; color: black; text-align: center;">Upcoming Features</h1>
<div class="card-deck row text-center" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">

    <!-- Dynamic Pricing -->
    <div class="card" style="width: 300px; border: 1px solid #e0e0e0; border-radius: 10px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
        <p class="aligncenter" style="margin-top: 15px;">
            <img class="card-img-top image" src="../Images/Homepage/pricing.png" alt="Dynamic Pricing" width="250px" height="200px">
        </p>
        <div class="card-body">
            <h4 class="card-title font-weight-bold">Dynamic Pricing</h4>
            <br>
            <h5 class="card-text">Negotiate and lock prices based on demand and availability</h5>
        </div>
    </div>
    ...
    <div class="card" style="width: 300px; border: 1px solid #e0e0e0; border-radius: 10px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
        <p class="aligncenter" style="margin-top: 15px;">
            <img class="card-img-top image" src="../Images/Homepage/sms.png" alt="SMS System" width="250px" height="200px">
        </p>
        <div class="card-body">
            <h4 class="card-title font-weight-bold">SMS Product Update</h4>
            <br>
            <h5 class="card-text">Add or modify products instantly through SMS commands</h5>
        </div>
    </div>
    ...
    <div class="card" style="width: 300px; border: 1px solid #e0e0e0; border-radius: 10px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
        <p class="aligncenter" style="margin-top: 15px;">
            <img class="card-img-top image" src="../Images/Homepage/forecast.png" alt="Demand Forecasting" width="250px" height="200px">
        </p>
        <div class="card-body">
            <h4 class="card-title font-weight-bold">Demand Forecasting</h4>
            <br>
            <h5 class="card-text">Analyze trends to grow what’s in demand and plan better</h5>
        </div>
    </div>
